...
class Message {
  ...
  static Message fromJson(Map<String, dynamic> json) {
    return Message(
      ...
      forwardFromChat: callIfNotNull(Chat.fromJson, json['forward_from_chat']),
      ...
      replyToMessage: callIfNotNull(Message.fromJson, json['reply_to_message']),
      editDate: json['edit_date'],
      mediaGroupId: json['media_group_id'],
      authorSignature: json['author_signature'],
      text: json['text'],
      entities: callIfNotNull(MessageEntity.listFromJsonArray, json['entities']),
      captionEntities: callIfNotNull(MessageEntity.listFromJsonArray, json['caption_entities']),
      ...
      newChatMembers: callIfNotNull(User.listFromJsonArray, json['new_chat_members']),
      leftChatMember: callIfNotNull(User.fromJson, json['left_chat_member']),
      newChatTitle: json['new_chat_title'],
      newChatPhoto: callIfNotNull(PhotoSize.listFromJsonArray, json['new_chat_photo']),
      ...
      successfulPayment: callIfNotNull(SuccessfulPayment.fromJson, json['successful_payment']),
      connectedWebsite: json['connected_website'],
      passportData: callIfNotNull(PassportData.fromJson, json['passport_data']),
      replyMarkup: callIfNotNull(InlineKeyboardMarkup.fromJson, json['reply_markup']),
    );
  }
